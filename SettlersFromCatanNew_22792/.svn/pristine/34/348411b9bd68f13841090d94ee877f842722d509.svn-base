...
public class Player {
    ...
    public Player(PlayerTeam team, String name) {
        ...
        GameStart.mainLogger.getLOGGER().fine("Player \"" + name + "\" in team " + team + " has been created");
    }
    ...
    public void addResources(HashMap<ResourceType, Integer> newResources) {
    	GameStart.mainLogger.getLOGGER().fine("BEFORE ADDING: " + resources.toString());
    	GameStart.mainLogger.getLOGGER().fine("TO ADD: " + newResources.toString());

        for (ResourceType type : newResources.keySet()) {
            GameStart.mainLogger.getLOGGER().fine(type + "_"+ resources.get(type));
    	...
    	GameStart.mainLogger.getLOGGER().fine("AFTER ADDING: " + resources.toString());
    ...
    public void subtractResources(HashMap<ResourceType, Integer> resourcesToSubtract) {
    	GameStart.mainLogger.getLOGGER().fine("BEFORE SUBTRACTING: " + resources.toString());
    	GameStart.mainLogger.getLOGGER().fine("TO SUBRTACT: " + resourcesToSubtract.toString());
    	...
    	GameStart.mainLogger.getLOGGER().fine("AFTER SUBTRACTING: " + resources.toString());
    }
...
//        GameStart.mainLogger.getLOGGER().fine("RESOURCE BEFORE OVERWRITE: " + resources);
...
//        GameStart.mainLogger.getLOGGER().fine("RESOURCE AFTER OVERWRITE: " + resources);
//    }
    ...
    public void removeSingleEvolutionCard(EvolutionType cardType) {
        if (evolutionCards.containsKey(cardType)) {
            if (evolutionCards.get(cardType) < 1) {
                GameStart.mainLogger.getLOGGER().fine("Player has no evolution cards of this type");
                return;
