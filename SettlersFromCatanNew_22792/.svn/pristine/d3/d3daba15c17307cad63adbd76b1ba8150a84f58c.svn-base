...
public class MainMenu {
	...
	public MainMenu(GameView gameView) {
		...
		musicVolumeSlider = new Slider(1,10,GameStart.soundManager.getMusicVolumeValue());
		...
		soundEffectsVolumeSlider = new Slider(1,10,GameStart.soundManager.getSoundEffectsVolumeValue()*10);
