...
public class Resources {
	...
	public void substractFromResources(Resources resources) {
		...
		if(this.wood < 0 || this.loam <0 || this.wool <0 || this.stone <0 || this.grain < 0)
			try {
				throw new Exception("MINUS RESOURCES");
			} catch (Exception e) {
	...
	public int getResource(String resource) {
		...
		GameStart.mainLogger.getLOGGER().fine("Wrong input at getResource()");
		return -1;
	}
